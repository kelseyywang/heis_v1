const strings = {
  ...
  traitorMapHelp: `This will display any location information that the Tracer gets, as well as aim. Distance will appear as a circle (the Tracer is anywhere on the border of the circle), and Direction will appear as a line (the Tracer is anywhere on the line).`,
  ...
  tracerMapHelp: `This will display any location information, aim, and tint black if Traitor Disguises. Distance will appear as a circle (the Traitor is anywhere on the border of the circle), and Direction will appear as a line (the Traitor is anywhere on the line).`,
